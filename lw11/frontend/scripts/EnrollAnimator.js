export class EnrollAnimator 
{
    ...
    {
        this.isShown = true;
        this.enroll.classList.remove( "enroll__hide" );
        this.enroll.classList.remove( "enroll__shrink" );
        this.enrollBackground.classList.remove( "enroll__hide" );
    }

    Hide() 
    {
        this.isShown = false;
        this.enroll.classList.add( "enroll__hide" );
        this.enroll.classList.add( "enroll__shrink" );
        this.enrollBackground.classList.add( "enroll__hide" );
    }
